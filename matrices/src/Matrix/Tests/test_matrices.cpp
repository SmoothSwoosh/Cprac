...
int main() {
    ...
    Matrix<Rational_number<int>> own2(5, 5, 2, 0.0001, true);
    Matrix<Rational_number<int>> own3(1000000, 1000000);
    ...
    // auto s = own3[{500000, 500000, 500002, 500002}];
    ...
    // std::cout << Rational_number<int>(2) * own3 << std::endl;
